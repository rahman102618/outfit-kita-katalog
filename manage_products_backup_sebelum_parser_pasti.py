...
def build_bulk_product(products, pid, raw_line, link):
    ...
    # Nama dari teks share/baris input dipakai sebagai cadangan yang kuat.
...
def add_product():
    ...
    panel(
        ...
        "TikTok/Tokopedia: nama dan gambar dicoba otomatis dari link; harga bisa otomatis dari teks setelah link; kategori tetap dikonfirmasi.\n"
